      ...
      {sections.map((s) => (
        ...
        >
          {s.image ? (
            ...
            <div
              className="absolute inset-0 flex items-center justify-center text-white/15 text-sm tracking-widest uppercase"
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 bg-paper/15 border border-white/35 backdrop-blur-lg px-8 py-4 rounded-full transition-all duration-400 group-hover:scale-105 group-hover:-translate-y-2">
            <span className="text-sm md:text-base font-bold tracking-widest uppercase text-white flex items-center gap-3">
              {s.label}

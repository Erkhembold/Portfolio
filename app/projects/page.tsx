  ...
  return (
    <main className="min-h-screen bg-paper pt-20">
      <div className="relative bg-gradient-to-br from-accent/25 via-accent/5 to-transparent border-b border-border py-20 md:py-28 px-6 md:px-12">
        ...
        <h1 className="text-[clamp(3rem,11vw,8rem)] font-black leading-none tracking-tight text-ink">Projects</h1>
        <p className="mt-5 text-lg text-muted max-w-2xl">Initiatives, clubs, and community work I am involved in.</p>
      </div>
        ...
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start p-6 rounded-xl hover:bg-accent/5 transition-colors duration-300">
            <div className="flex-1 space-y-4">
              ...
              <h3 className="text-2xl md:text-3xl font-bold">Chinese Language Teaching Initiative</h3>
          ...
          <div className="flex flex-col md:flex-row-reverse gap-8 md:gap-12 items-start p-6 rounded-xl hover:bg-accent/5 transition-colors duration-300">
            <div className="flex-1 space-y-4">
              <div className="w-6 h-1 bg-accent rounded-full" />
              <h3 className="text-2xl md:text-3xl font-bold">Oyunlag French Club</h3>
          ...
          <div className="p-6 rounded-xl hover:bg-accent/5 transition-colors duration-300 space-y-4">
            <div className="w-6 h-1 bg-accent rounded-full" />
            <h3 className="text-2xl md:text-3xl font-bold">Media &amp; Digital Content Platforms</h3>
          ...
          <div className="p-6 rounded-xl hover:bg-accent/5 transition-colors duration-300 space-y-4">
            <div className="w-6 h-1 bg-accent rounded-full" />
            <h3 className="text-2xl md:text-3xl font-bold">Oyunlag School Red Cross Club</h3>
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start p-6 rounded-xl hover:bg-accent/5 transition-colors duration-300">
            <div className="flex-1 space-y-4">
              <div className="w-6 h-1 bg-accent rounded-full" />
              <h3 className="text-2xl md:text-3xl font-bold">Earth School Mongolia</h3>
